...
loginPlus.Manager.prototype.init = function init(app,opts){
    ...
    passport.serializeUser(function(user, done) {
        thisManager.savedUser[user[thisManager.userNameField]] = user;
        done(null, user[thisManager.userNameField]);
    });
...
loginPlus.Manager.prototype.setValidator = function setValidator(validatorStrategy, userNameField){
